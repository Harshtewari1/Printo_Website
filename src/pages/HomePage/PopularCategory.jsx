...
const CategoryGrid = () => {
    ...
    return (
        <div className="p-6 sm:p-10 bg-purple-50">
            <h2 className="text-2xl sm:text-4xl font-bold text-gray-800 mb-8 sm:mb-10 text-center">
                Popular Categories
            </h2>
            ...
            {/* Mobile Grid (simpler UI) */}
            <div className="grid grid-cols-2 gap-4 md:hidden">
                {categories.map((item, index) => (
                    <div
                        key={index}
                        className="bg-gray-100 rounded-xl flex flex-col items-center shadow p-3"
                    >
